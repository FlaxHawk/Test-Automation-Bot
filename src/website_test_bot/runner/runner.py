...
def setup_pytest_environment(test_dir: str, config: Config) -> Tuple[List[str], Dict[str, str]]:
    """
...
def run_pytest(test_files: List[str], test_dir: str, config: Config) -> subprocess.CompletedProcess:
    """
