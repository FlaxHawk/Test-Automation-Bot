...
class TestCase(BaseModel):
    ...
    video_path: Optional[str] = Field(None, description="Path to video")
    trace_path: Optional[str] = Field(None, description="Path to trace")
    html_path: Optional[str] = Field(None, description="Path to HTML result")
...
class TestResults(BaseModel):
    ...
    junit_report: Optional[str] = Field(None, description="Path to JUnit report") 